...
export default function Page() {
    ...
    return (
        <div className="max-w-6xl py-4 mx-auto sm:py-16 sm:px-24">
            {result !== null && !loading && (
                <h1 className="text-3xl font-medium"> Marca {result[0].category.categoryName}</h1>
            )}
            <Separator />
            ...
            <div className="sm: flex sm:justify-between">
                ...
                <div className="grid gap-5 mt-8 sm:grid-cols-2 md:grid-cols-3 md:gap-10">
                    ...
                    {filteredProducts !== null && filteredProducts.length === 0 && (
                        <p className="text-center col-span-3">No hay productos disponibles para este filtro</p>
                    )}
                </div>
            </div>
        </div>
