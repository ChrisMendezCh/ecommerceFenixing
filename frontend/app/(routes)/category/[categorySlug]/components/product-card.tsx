...
const ProductCard = (props: ProductCardProps) => {
    ...
    return (
      ...
      className="relative p- transition-all duration-100 rounded-lg hover:shadow-md">
        <div className="absolute flex items-center justify-between gap-3 px-2 z-[1] top-4">
            <p className="px-2 py1 text-xs text-white bg-yellow-500 rounded-full w-fit">{product.origin}</p>
        </div>
        <Carousel
